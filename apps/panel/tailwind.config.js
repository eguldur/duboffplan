...
const generatePalette = require(
    resolve(__dirname, 'src/@fuse/tailwind/utils/generate-palette')
);
...
module.exports = {
  ...
  darkMode: 'class',
    ...
    plugins: [
        ...
        require(
            resolve(__dirname, 'src/@fuse/tailwind/plugins/utilities')
        ),
        require(
            resolve(__dirname, 'src/@fuse/tailwind/plugins/icon-size')
        ),
