...
export class IconsMockApi {
    ...
    registerHandlers(): void {
        ...
        // @ Feather icons - GET
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService.onGet('api/administration/icons/feather').reply(() => [
            200,
            {
                namespace: 'feather',
                name: 'Feather',
        ...
        this._fuseMockApiService
            .onGet('api/administration/icons/heroicons-outline')
            .reply(() => [
                200,
                {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/administration/icons/heroicons-solid')
            .reply(() => [
                200,
                {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/administration/icons/heroicons-mini')
            .reply(() => [
                200,
                {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/administration/icons/material-solid')
            .reply(() => [
                200,
                {
                    namespace: 'mat_solid',
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/administration/icons/material-outline')
            .reply(() => [
                200,
                {
        ...
        // -----------------------------------------------------------------------------------------------------
        this._fuseMockApiService
            .onGet('api/administration/icons/material-twotone')
            .reply(() => [
                200,
                {
                    namespace: '',
