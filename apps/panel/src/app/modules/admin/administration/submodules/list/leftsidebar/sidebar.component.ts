...
import { SubModulesService } from '../../modules.service'
import { SubModulesListComponent } from '../module.component'
...
export class SidebarComponent implements OnInit, OnDestroy {
   ...
   * Constructor
   */
  constructor(private _itemService: SubModulesService,     private _formBuilder: UntypedFormBuilder, public _component: SubModulesListComponent) {
          ...
          children: [
            {
              ...
              link : '/administration/submodules/0',
              badge: {
            ...
            },
            {
              ...
              link : '/administration/submodules/1',
              badge: {
            ...
            },
            {
              ...
              link : '/administration/submodules/2',
              badge: {
