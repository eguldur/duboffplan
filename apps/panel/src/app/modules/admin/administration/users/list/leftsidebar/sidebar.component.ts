...
import { UsersListComponent } from '../module.component'
...
export class SidebarComponent implements OnInit, OnDestroy {
   ...
   * Constructor
   */
  constructor(private _itemService: UsersService,     private _formBuilder: UntypedFormBuilder, public _component: UsersListComponent) {
