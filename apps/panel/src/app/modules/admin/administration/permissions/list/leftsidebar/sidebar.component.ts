...
import { PermissionsListComponent } from '../module.component'
        ...
        <div class="flex flex-col sm:flex-row p-6 pt-0">
          <div class="flex flex-auto flex-wrap">
            <mat-form-field class="w-full">
              ...
              <mat-select [formControlName]="'basemodule'" [placeholder]="'Lütfen Seçiniz'">
                <ng-container *ngFor="let basemodule of selects.basemodules">
                  <mat-option [value]="basemodule.id"> {{basemodule.title}} </mat-option>
                </ng-container>
              </mat-select>
            </mat-form-field>
            ...
            <button class="w-full mt-2" mat-flat-button [color]="'accent'">
              ...
              <span (click)="this.exportToExcell(false)"  *ngIf="this.moduleConfig.exportItems" class="ml-2 mr-1 hidden md:block">Excel'e Aktar</span>
            </button>
            <!--
            <button class="w-full mt-2" mat-flat-button [color]="'accent'">
...
export class SidebarComponent implements OnInit, OnDestroy {
   ...
   * Constructor
   */
  constructor(private _itemService: PermissionsService,     private _formBuilder: UntypedFormBuilder, public _component: PermissionsListComponent) {
  ...
  createFilterForm(): void {
    this.filterForm = this._formBuilder.group({
      basemodule: [this.filter?.basemodule],
    })
  }
          ...
          children: [
            {
              ...
              link : '/administration/permissions/0',
              badge: {
            ...
            },
            {
              ...
              link : '/administration/permissions/1',
              badge: {
            ...
            },
            {
              ...
              link : '/administration/permissions/2',
              badge: {
