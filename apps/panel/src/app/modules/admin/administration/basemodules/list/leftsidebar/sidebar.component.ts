...
import { BaseModulesListComponent } from '../module.component'
...
export class SidebarComponent implements OnInit, OnDestroy {
   ...
   * Constructor
   */
  constructor(private _itemService: ModulesService,     private _formBuilder: UntypedFormBuilder, public _component: BaseModulesListComponent) {
          ...
          children: [
            {
              ...
              link : '/administration/basemodules/0',
              badge: {
            ...
            },
            {
              ...
              link : '/administration/basemodules/1',
              badge: {
            ...
            },
            {
              ...
              link : '/administration/basemodules/2',
              badge: {
